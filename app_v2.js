...
const SESSION_FILE_PATH = './data/session'+Math.floor(Math.random() * 10000) + 1+'.json';
...
client.on('message', async message => {
	...
	if(message.body === '!ping') {    // Replying to messages
        ...
        const filePath = './data/branco.jpg';
        ...
        //const media = new MessageMedia.fromFilePath('./data/branco.jpg');
        client.sendMessage(message.from,media);  // send reply using the sendMessage
    }
